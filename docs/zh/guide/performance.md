...
它会构建 playground，通过 `vite preview` 跑场景，并在 `benchmark/` 下生成 JSON 与 Markdown 报告，包含环境披露、LCP、CLS、settle time、p95 frame cost、long task、DOM 节点数、fallback、滚动漂移和 heap after unmount 等指标。
