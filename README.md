...
For docs pages that do not need Monaco-backed code blocks, set `:render-code-blocks-as-pre="true"` or install the optional code-block peers before using the rich defaults.
