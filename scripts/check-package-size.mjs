...
const budgets = {
  maxDistBytes: Number(process.env.MAX_DIST_BYTES || 870 * 1024),
  maxJsChunkBytes: Number(process.env.MAX_JS_CHUNK_BYTES || 240 * 1024),
  maxPackSizeBytes: Number(process.env.MAX_PACK_TGZ_BYTES || 240 * 1024),
  maxPackUnpackedBytes: Number(process.env.MAX_PACK_UNPACKED_BYTES || 945 * 1024),
}
